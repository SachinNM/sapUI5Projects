sap.ui.define([
	...
	return Controller.extend("test.performance.app.TestingPerformanceApps.controller.LandingListPage", {
		onInit: function () {
		...
		onPressContinue: function (oEvent) {
			...
			var oDataShared = {
				...
				FromDate: oFromDate.getDateValue().toString(),
				ToDate: oToDate.getDateValue().toString(),
				ReitzLayoutSelected: aTableReitzSelected,
				HausmanLayoutSelected: aTableHausmanSelected,
				SattledLayoutSelected: aTableSattledtSelected
			};
		},
